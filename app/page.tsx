        ...
        <section id="about" className="min-h-screen p-10 flex mt-10" style={{ scrollMarginTop: "80px" }}>
          ...
          >
            ...
            <p className="text-xl text-gray-300 break-words whitespace-normal">
              ...
              in my coursework, but I'm always up for learning new languages and tools. I enjoy building cool projects, and challenging myself through code. Outside of tech, I love hiking and
