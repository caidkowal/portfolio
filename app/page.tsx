...
<nav className="fixed top-6 right-6 w-[calc(50%-3rem)] bg-black/40 backdrop-blur-md border border-slate-500/30 rounded-2xl z-50 px-10 py-6"
  ...
  <div className="flex gap-8 justify-center items-center">
    <a href="#home" className="text-xl text-slate-500 hover:text-slate-400 transition-colors">Home</a>
    <a href="#about" className="text-xl text-slate-500 hover:text-slate-400 transition-colors">About</a>
    <a href="#projects" className="text-xl text-slate-500 hover:text-slate-400 transition-colors">Projects</a>
    <a href="#contact" className="text-xl text-slate-500 hover:text-slate-400 transition-colors">Contact</a>

    {/* DIVIDER */}
    <div className="w-px h-6 bg-slate-500/30" />

    {/* GITHUB */}
    <a href="https://github.com/caidkowal" target="_blank" rel="noopener noreferrer"
    ...
    {/* LINKEDIN */}
    <a href="https://www.linkedin.com/in/caidenkowalchuk/" target="_blank" rel="noopener noreferrer"
        className="text-slate-500 hover:text-slate-300 transition-colors duration-300">
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
